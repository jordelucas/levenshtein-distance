...
public class SearchWord implements Runnable {
	...
	private static volatile String usernameBestDistance = "";
	private static volatile int valueBestDistance = 100;
	...
	private void checkAndSetNewBestDistance(int currentDistance, String currentUsername) {
		if (currentDistance < valueBestDistance) {
			valueBestDistance = currentDistance;
			usernameBestDistance = currentUsername;
		}
	}
}
